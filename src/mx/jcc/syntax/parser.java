...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sun May 02 20:16:02 CDT 2021
  */
...
class CUP$parser$actions {
    ...
    public Map<String, List<List<Variable>>> valueTable  = new HashMap<>();
    ...
    public void nextRule(String name) {
        ...
        List<List<Variable>> rules = valueTable.get(name);
    ...
    public void insertValue(String name, String vid) {
        ...
        if (symbolTable.get(name) != VariableType.NON_TERMINAL) {
            System.err.printf("%s is non terminal\n", name);
            throw new Error(String.format("%s is non terminal\n", name));
        }
